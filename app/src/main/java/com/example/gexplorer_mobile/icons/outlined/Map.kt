...
val GexplorerIcons.Outlined.Map: ImageVector
    get() {
        if (map != null) {
            return map!!
        }
        map = Builder(name = "Map-outlined", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(760.0f, 228.0f)
                lineTo(640.0f, 274.0f)
                lineTo(640.0f, 742.0f)
                close()
                moveTo(200.0f, 732.0f)
                lineTo(320.0f, 686.0f)
                lineTo(320.0f, 218.0f)
                lineTo(200.0f, 258.0f)
                lineTo(200.0f, 732.0f)
                close()
