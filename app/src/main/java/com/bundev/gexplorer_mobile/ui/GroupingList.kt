...
import com.bundev.gexplorer_mobile.pages.TripDialog
import com.bundev.gexplorer_mobile.pages.TripItem

@Composable
fun<T, K: Comparable<K>> GroupingList(items: List<T>, groupBy: (T) -> K, title: (K) -> String, childFactory: @Composable (T) -> Unit) {
