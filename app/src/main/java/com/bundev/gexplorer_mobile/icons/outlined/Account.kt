...
val GexplorerIcons.Outlined.Account: ImageVector
    get() {
        if (account != null) {
            return account!!
        }
        account = Builder(name = "AccountOutlined", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                quadTo(506.0f, 440.0f, 523.0f, 423.0f)
                quadTo(540.0f, 406.0f, 540.0f, 380.0f)
                quadTo(540.0f, 354.0f, 523.0f, 337.0f)
                quadTo(506.0f, 320.0f, 480.0f, 320.0f)
                quadTo(454.0f, 320.0f, 437.0f, 337.0f)
                quadTo(420.0f, 354.0f, 420.0f, 380.0f)
                quadTo(420.0f, 406.0f, 437.0f, 423.0f)
                quadTo(454.0f, 440.0f, 480.0f, 440.0f)
                close()
