...
val GexplorerIcons.Outlined.Palette: ImageVector
    get() {
        if (palette != null) {
            return palette!!
        }
        palette = Builder(name = "Palette", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                quadTo(489.0f, 800.0f, 494.5f, 795.0f)
                quadTo(500.0f, 790.0f, 500.0f, 782.0f)
                quadTo(500.0f, 768.0f, 485.0f, 749.0f)
                quadTo(470.0f, 730.0f, 470.0f, 692.0f)
                quadTo(470.0f, 650.0f, 499.0f, 625.0f)
                quadTo(528.0f, 600.0f, 570.0f, 600.0f)
                lineTo(640.0f, 600.0f)
                quadTo(706.0f, 600.0f, 753.0f, 561.5f)
                quadTo(800.0f, 523.0f, 800.0f, 442.0f)
                quadTo(800.0f, 321.0f, 707.5f, 240.5f)
                quadTo(615.0f, 160.0f, 488.0f, 160.0f)
                quadTo(352.0f, 160.0f, 256.0f, 253.0f)
                quadTo(160.0f, 346.0f, 160.0f, 480.0f)
                quadTo(160.0f, 613.0f, 253.5f, 706.5f)
                quadTo(347.0f, 800.0f, 480.0f, 800.0f)
                close()
            }
        }
        .build()
